...
if [ ! -f "/etc/network/interfaces.d/${if_filename}" ] ; then
  echo "Permantly added the route"
  echo "# Generated by eXtremeSHOK.com" > "/etc/network/interfaces.d/${if_filename}"
  echo "up route add -net $networkip netmask $netmask dev $gatewaydev" > "/etc/network/interfaces.d/${if_filename}"
else
