...
#set size of swap partition or leave blank for autoconfig, USE NUMBER ONLY, will be in gbytes
MY_SWAP=""
#set size of cache partition or leave blank for autoconfig, USE NUMBER ONLY, will be in gbytes
MY_CACHE=""
