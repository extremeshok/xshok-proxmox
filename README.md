...
https://raw.githubusercontent.com/Cris-F/xshok-proxmox/master/install-post.sh
...
````
wget https://raw.githubusercontent.com/Cris-F/xshok-proxmox/master/install-hetzner.sh -c -O install-hetzner.sh && chmod +x install-hetzner.sh
./install-hetzner.sh
````
* Reboot
...
## LVM to ZFS
````
wget https://raw.githubusercontent.com/Cris-F/xshok-proxmox/master/lvm-2-zfs.sh -c -O lvm-2-zfs.sh  && chmod +x lvm-2-zfs.sh
...
```
wget https://raw.githubusercontent.com/Cris-F/xshok-proxmox/master/network-configure.sh -c -O network-configure.sh && chmod +x network-configure.sh
...
## LVM to ZFS
````
wget https://raw.githubusercontent.com/CrisF/xshok-proxmox/master/lvm-2-zfs.sh -c -O lvm-2-zfs.sh  && chmod +x lvm-2-zfs.sh
 ./lvm-2-zfs.sh && rm lvm-2-zfs.sh
````
* Reboot
* Connect via ssh/terminal to the new Proxmox system running on your server and run the following
...
```
wget https://raw.githubusercontent.com/CrisF/xshok-proxmox/master/createzfs.sh -c -O createzfs.sh && chmod +x createzfs.sh
...
```
wget https://raw.githubusercontent.com/Cris-F/xshok-proxmox/master/xshok_slog_cache-2-zfs.sh -c -O xshok_slog_cache-2-zfs.sh && chmod +x xshok_slog_cache-2-zfs.sh
...
```
curl -O https://raw.githubusercontent.com/Cris-F/xshok-proxmox/master/debian9-2-proxmox5.sh && chmod +x debian9-2-proxmox5.sh
...
```
curl https://raw.githubusercontent.com/Cris-F/xshok-proxmox/master/pve-enable-lxc-docker.sh --output /usr/sbin/pve-enable-lxc-docker && chmod +x /usr/sbin/pve-enable-lxc-docker
...
**NOTE: WILL  DESTROY ALL DATA ON SPECIFIED DEVICES**
```
wget https://raw.githubusercontent.com/Cris-F/xshok-proxmox/master/createzfs.sh -c -O createzfs.sh && chmod +x createzfs.sh
./createzfs.sh poolname /dev/device1 /dev/device2
```
...
```
wget https://raw.githubusercontent.com/Cris-F/xshok-proxmox/master/network-addiprange.sh -c -O network-addiprange.sh && chmod +x network-addiprange.sh
...
```
wget https://raw.githubusercontent.com/Cris-F/xshok-proxmox/master/tincvpn.sh -c -O tincvpn.sh && chmod +x tincvpn.sh
./tincvpn.sh -h
```
